...
module.exports = {
  db: {
    uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/shareal-dev',
    options: {},
  ...
  livereload: true,
  seedDB: { //Hardcoded to true for now - don't have to worry about env issues
