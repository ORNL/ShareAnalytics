...
module.exports.initLocalVariables = function (app) {
  ...
  //Set up variables for folder paths
  //CUSTOM CONFIG FOR REDACT
  app.locals.resultfolderpath = "/tmp/results/";
  app.locals.datasetfolderpath = "/tmp/datasets/";
  app.locals.analyticfolderpath = "/tmp/analytics/";  
  app.locals.dashboardfolderpath = "/tmp/dashboards/"
