...
//Only these fields can be changed by the user
var whitelistedFields = ['firstName', 'lastName', 'email', 'username','useGravatar'];
...
/**
 * Update user details
 * Make sure that any fields you want to update are in the whitelistedFields list
 */
...
exports.me = function (req, res) {
  ...
  if (req.user) {
    safeUserObject = {
      ...
      useGravatar: req.user.useGravatar,
